...
showNotification:function(e,a,msg=null,clr=null){type=["","info","danger","success","warning","rose","primary"],
color=clr?clr:type[Math.floor((Math.random() * 6) + 1)],
$.notify({icon:"add_alert",message: msg /*"Welcome to <b>Material Dashboard Pro</b> - a beautiful admin panel for every web developer."*/},
	{type:color,timer:3e3,placement:{from:e,align:a}})},
