    ...
    <div class="dropdown show-dropdown">
        ...
        <ul class="dropdown-menu">
	            ...
	            <a href="javascript:void(0)" class="switch-trigger">
		            ...
		            <label class="ml-auto">
		                <div class="togglebutton switch-sidebar-mini">
		                  	<label> <input type="checkbox"> <span class="toggle"></span> </label>
		                </div>
		            </label>
	              <div class="clearfix"></div>
	            </a>
	        ...
	        <li style="text-align: center; width: 100%;">
	            <a class="" style="display: inline;" data-icon="octicon-star" data-size="large" data-show-count="true"> 
	            	{{ App\Models\Role::where('name',Auth::user()->role)->get()->first()->display_name }} 
	            </a>
	        </li>
          	<li class="header-title">Thanks for using {{ config('app.name') }}</li>
          	<li></li>
