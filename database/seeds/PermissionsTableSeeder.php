...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = [
        	...
        	[
                'name'          => 'can_view_post',
                'display_name'  => 'Can view a post',
                'description'   => 'User can see posts and their details',
            ],
        	[
                'name'          => 'can_view_questions',
                'display_name'  => 'Can view a question',
                'description'   => 'User can view questions and their details',
            ],
            // [
            //     'name'          => '',
            //     'display_name'  => '',
